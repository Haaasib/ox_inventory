...
shared.body = lib.load('data.body') or {}
shared.bodyItems = {}

if shared.body.slots and shared.body.items then
    for name, key in pairs(shared.body.items) do
        shared.bodyItems[name] = shared.body.slots[key]
    end
end
